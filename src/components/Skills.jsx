        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {skillCategories.map((category) => (
            <div 
              ...
              className="glass card-reveal interactive-card rounded-[2.5rem] p-8 border border-primary/10 hover:border-primary/30 transition-all duration-300 relative group hover:-translate-y-2 shadow-xl shadow-primary/5 hover:shadow-2xl hover:shadow-primary/15 flex flex-col justify-between"
            >
              <div>
