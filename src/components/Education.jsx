        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative pl-6 md:pl-10 border-l-4 border-primary/30 space-y-12">
            ...
            <div className="relative group">
              ...
              <div className="glass card-reveal interactive-card p-8 rounded-[2rem] border border-primary/10 hover:border-primary/30 transition-all duration-300 shadow-xl shadow-primary/5 hover:shadow-2xl hover:shadow-primary/10">
