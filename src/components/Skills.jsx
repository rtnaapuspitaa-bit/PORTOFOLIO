const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      title: 'Software',
      skills: [
        { name: 'VS Code', icon: <svg viewBox="0 0 128 128" className="w-12 h-12 text-[#007ACC]" fill="currentColor"><path d="M89.7 104.9l-49.2-40 49.2-40.4v80.4zm5.8 8.1L120 94.4V33.6L95.5 15l-13 10.8 28.5 23.2L68 83 45.9 64.6 8.5 94.8l64 45.1 23-16.9zm-27-21l-22.6-19.1v-.1l22.6-18.7v37.9zM120 33.6v60.8l-24.5 18.6L68 83 111 49 82.5 25.8 95.5 15zM8.5 33.2l37.4 31.4L68 45l-59.5-30.2v18.4z"/></svg> },
        { name: 'Visual Studio', icon: <svg viewBox="0 0 128 128" className="w-12 h-12 text-[#5C2D91]" fill="currentColor"><path d="M96 15l-19 14.5L50 15 15 36.5v55L50 113l27-14.5L96 113l17-21.5v-55zm-15 67.5L59.5 64 81 45.5v37zM45.5 83L25 66l20.5-17v34z"/></svg> },
        { name: 'Figma', icon: <svg viewBox="0 0 128 128" className="w-12 h-12 text-[#F24E1E]" fill="currentColor"><path fill="#1abcfe" d="M64 64a18 18 0 1 1 36 0 18 18 0 0 1-36 0z"/><path fill="#0acf83" d="M28 100a18 18 0 0 1 18-18h18v18a18 18 0 1 1-36 0z"/><path fill="#ff7262" d="M64 10v36h18a18 18 0 1 0 0-36H64z"/><path fill="#f24e1e" d="M28 28a18 18 0 0 0 18 18h18V10H46A18 18 0 0 0 28 28z"/><path fill="#a259ff" d="M28 64a18 18 0 0 0 18 18h18V46H46A18 18 0 0 0 28 64z"/></svg> }
      ]
    }
  ];
