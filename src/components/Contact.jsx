...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      link: 'https://github.com/rtnaapuspitaa-bit',
      icon: (
    ...
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/rtnpspita?igsh=MWc0c2UydmlhODdvcA%3D%3D&utm_source=qr',
      icon: (
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      link: 'https://www.linkedin.com/in/ratna-puspita-sari-5836b1428/',
      icon: (
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
          <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.25V10.9H6.46M7.86 6.69a1.63 1.63 0 1 0 0 3.26 1.63 1.63 0 0 0 0-3.26Z"/>
        </svg>
      )
    },
    {
      name: 'WhatsApp',
      link: 'https://wa.me/6285777140137',
      icon: (
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email Direct',
      link: 'https://mail.google.com/mail/?view=cm&fs=1&to=rtnaapuspitaa@gmail.com',
      icon: (
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-gradient-to-b from-light via-accent/15 to-light">
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        {/* Icon-Only Social Links Row (Seperti Gambar 2) */}
        <div className="flex items-center justify-center gap-4 md:gap-6 mb-12">
          {socialLinks.map((item, index) => (
            <a
              ...
              title={item.name}
              className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-dark text-white hover:bg-primary flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 group"
            >
